export default class GameScene extends Phaser.Scene {
    ...
    create() {
        ...
        this.turnText;
        this.chatMessages = [];
        this.playerAUsername;
        this.playerBUsername;
        ...
        this.socket.on('whoseTurn', (coinFlip, playerAUsername, playerBUsername) => {
            self.playerAUsername = playerAUsername;
            self.playerBUsername = playerBUsername;
