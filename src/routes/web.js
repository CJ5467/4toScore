...
import searchPlayersController from "../controllers/searchPlayersController";
...
let initWebRoutes = (app) => {
    ...
    router.get("/searchplayers", loginController.checkLoggedIn, searchPlayersController.getUsers);
